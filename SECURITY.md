...
Python client for the CI360 Marketing Execution API — bulk task execution across channel types such as email and mobile.
...
Please do not report security vulnerabilities by opening a public issue on GitHub.
